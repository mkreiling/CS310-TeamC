...
public class Feature3 {
    ...
    public void testAdjustPunchesShift1Weekday() {
        ...
        assertEquals("#28DC3FB8 CLOCK IN: FRI 09/07/2018 06:50:35", 
p1.printOriginal());
        assertEquals("#28DC3FB8 CLOCK IN: FRI 09/07/2018 07:00:00 (Shift Start)", 
p1.printAdjusted());
        
        assertEquals("#28DC3FB8 CLOCK OUT: FRI 09/07/2018 12:03:54", 
p2.printOriginal());
        assertEquals("#28DC3FB8 CLOCK OUT: FRI 09/07/2018 12:00:00 (Lunch Start)", 
p2.printAdjusted());
        
        assertEquals("#28DC3FB8 CLOCK IN: FRI 09/07/2018 12:23:41", 
p3.printOriginal());
        assertEquals("#28DC3FB8 CLOCK IN: FRI 09/07/2018 12:30:00 (Lunch Stop)", 
p3.printAdjusted());
        assertEquals("#28DC3FB8 CLOCK OUT: FRI 09/07/2018 15:34:13", 
p4.printOriginal());
        assertEquals("#28DC3FB8 CLOCK OUT: FRI 09/07/2018 15:30:00 (Shift Stop)", 
p4.printAdjusted());
...
Round)", p2.printAdjusted());
    ...
    public void testAdjustPunchesShift2Weekday() {
        ...
        /* Compare Adjusted Timestamps to Expected Values */
        assertEquals("#08D01475 CLOCK IN: TUE 09/18/2018 11:59:33", 
p1.printOriginal());
        assertEquals("#08D01475 CLOCK IN: TUE 09/18/2018 12:00:00 (Shift Start)", 
p1.printAdjusted());
        
        assertEquals("#08D01475 CLOCK OUT: TUE 09/18/2018 21:30:27", 
p2.printOriginal());
        assertEquals("#08D01475 CLOCK OUT: TUE 09/18/2018 21:30:00 (None)", 
p2.printAdjusted());
...
Round)", p2.printAdjusted());
    ...
    public void testAdjustPunchesShift1SpecialCases() {
        ...
        /* Compare Adjusted Timestamps to Expected Values */
        assertEquals("#BE51FA92 CLOCK IN: WED 08/01/2018 06:48:20", 
p1.printOriginal());
        assertEquals("#BE51FA92 CLOCK IN: WED 08/01/2018 07:00:00 (Shift Start)", 
p1.printAdjusted());
        
        assertEquals("#3DA8B226 CLOCK IN: FRI 08/24/2018 07:02:23", 
p2.printOriginal());
        assertEquals("#3DA8B226 CLOCK IN: FRI 08/24/2018 07:00:00 (Shift Start)", 
p2.printAdjusted());
        assertEquals("#8E5F0240 CLOCK IN: MON 08/27/2018 07:08:57", 
p3.printOriginal());
        assertEquals("#8E5F0240 CLOCK IN: MON 08/27/2018 07:15:00 (Shift Dock)", 
p3.printAdjusted());
...
p5.printAdjusted());
        assertEquals("#1B2052DE CLOCK OUT: TUE 08/14/2018 15:15:00", 
p6.printOriginal());
        assertEquals("#1B2052DE CLOCK OUT: TUE 08/14/2018 15:15:00 (Shift Dock)", 
p6.printAdjusted());
        assertEquals("#ADD650A8 CLOCK OUT: TUE 09/11/2018 15:37:12", 
p7.printOriginal());
        assertEquals("#ADD650A8 CLOCK OUT: TUE 09/11/2018 15:30:00 (Shift Stop)", 
p7.printAdjusted());
